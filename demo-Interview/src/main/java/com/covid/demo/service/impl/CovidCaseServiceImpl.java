...
public class CovidCaseServiceImpl implements CovidCaseService{
	...
	public List<CovidCasesPerPeriod> findCovidCasesPerDay(String country, boolean testResult) {
		return covidCaseRepository.findCovidCasesPerDay(country, testResult);
	}
	...
	public List<CovidCasesPerPeriod> findCovidCasesPerYear(String country, boolean testResult) {
		return covidCaseRepository.findCovidCasesPerYear(country, testResult);
	}
	/**
	 * Represents a service.
	...
	public List<CovidCasesPerPeriod> findCovidCasesPerMonth(String country, boolean testResult) {
		return covidCaseRepository.findCovidCasesPerMonth(country, testResult);
	}
