...
INSERT INTO COVID_CASE values (1,parsedatetime('08-12-2020', 'dd-MM-yyyy'),true,0011223344);
INSERT INTO COVID_CASE values (2,parsedatetime('10-11-2020', 'dd-MM-yyyy'),true,0011223345);
...
INSERT INTO COVID_CASE values (4,parsedatetime('15-08-2020', 'dd-MM-yyyy'),false,0011223345);
INSERT INTO COVID_CASE values (6,parsedatetime('08-12-2021', 'dd-MM-yyyy'),true,0011223345);
INSERT INTO COVID_CASE values (7,parsedatetime('08-11-2021', 'dd-MM-yyyy'),true,0011223345);
INSERT INTO COVID_CASE values (8,parsedatetime('08-02-2020', 'dd-MM-yyyy'),true,0011223345);
